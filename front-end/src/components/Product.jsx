    ...
    return (
        <div className="relative flex w-full max-w-xs flex-col overflow-hidden rounded-2xl border border-gray-300 shadow-lg transition-transform hover:scale-102 hover:shadow-xl ">
            ...
            <div className="p-4 space-y-3">
                ...
                <Link
                    className="flex items-center justify-center gap-2 w-full rounded-lg bg-white border-2 border-primary font-semibold transition hover:bg-primary hover:text-white"
